...
savefolder='Croco\\Light05'
dpi=100
Savefig2(savefolder,11,dpi)
Savetxt(Iarray,savefolder,'IarrayN2fix')
Savetxt(N2fix,savefolder,'N2fix')
savetxt('Light05\\N2fix.csv',N2fix,delimiter=",",fmt='%2.8f')
savetxt('Light05\\IarrayN2fix.csv',Iarray,delimiter=",",fmt='%2.8f')
...
savetxt('Light05\\Pchl.csv',PI,delimiter=",",fmt='%2.8f')
savetxt('Light05\\IarrayPchl.csv',Iarray2,delimiter=",",fmt='%2.8f')
