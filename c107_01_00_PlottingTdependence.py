...
def sf(name):
    Savefig3('Croco\\Tdepend02\\Paper',name,600)
...
ln1=ax1.plot(T,N2fix0,label='N$_2$fix')
...
figure(2)
plot(T,N2fix0,'b',label='All')
plot(T,N2fix1, color='b',dashes=[3,5],label='N$_{2}$fix')
plot(T,N2fix2, color='b',dashes=[11,7],label='Photo')
plot(T,N2fix3, color='b',dashes=[3,3,10,3],label='Resp')
xlim(14,28)
ylim(0,13)
title('T effects on N$_2$fix',y=1.02)
